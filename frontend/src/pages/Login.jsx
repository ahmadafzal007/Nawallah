            ...
            <div className="rounded-full  sm:w-full justify-between w-[377px] h-16 items-center px-4 flex flex-row gap-3 border-[#b8a6a60d] border-solid text-black font bg-[#ffffff]">
              <div className="flex flex-row justify-center items-center gap-3">
                ...
                <input
                  ...
                  className="text-base   focus:outline-none focus:ring-0 font-normal seletor text-[#000000] my-5  bg-[#ffffff] "
              ...
              <div className="justify-right">
                ...
                >
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M11.6721 23.6667C17.9917 23.6667 23.1147 18.4434 23.1147 12C23.1147 5.55672 17.9917 0.333374 11.6721 0.333374C5.35253 0.333374 0.229492 5.55672 0.229492 12C0.229492 18.4434 5.35253 23.6667 11.6721 23.6667Z"
                    fill="#FF6154"
                  />
                  <path
                    d="M8.23926 13C8.23926 13 9.09745 13 9.95565 14.6667C9.95565 14.6667 12.6817 10.5 15.1048 9.66671"
                    stroke="#353535"
            ...
            <div className="rounded-full justify-between sm:w-full w-[377px] h-16 mt-[18px] items-center px-4 flex flex-row gap-3 border-[#bdbdbd0d] border-solid bg-[#ffffff]">
              <div className="flex flex-row justify-center items-center gap-3">
                ...
                >
                  <g opacity="0.4">
                    <path
                      d="M1.40317 15.8093C1.59616 17.2446 2.78343 18.3692 4.22823 18.4357C5.44396 18.4916 6.67893 18.5208 8.03891 18.5208C9.39889 18.5208 10.6339 18.4916 11.8496 18.4357C13.2944 18.3692 14.4817 17.2446 14.6747 15.8093C14.8006 14.8725 14.9045 13.9125 14.9045 12.9349C14.9045 11.9572 14.8006 10.9973 14.6747 10.0605C14.4817 8.62515 13.2944 7.50063 11.8496 7.43412C10.6339 7.37815 9.39889 7.34896 8.03891 7.34896C6.67893 7.34896 5.44396 7.37815 4.22823 7.43412C2.78343 7.50063 1.59616 8.62515 1.40317 10.0605C1.27722 10.9973 1.17334 11.9572 1.17334 12.9349C1.17334 13.9125 1.27722 14.8725 1.40317 15.8093Z"
                      stroke="#BDBDBD"
                      stroke-width="1.5"
                    />
                    <path
                      d="M4.17725 7.34896V5.20052C4.17725 3.06473 5.90627 1.33333 8.03913 1.33333C10.172 1.33333 11.901 3.06473 11.901 5.20052V7.34896"
                      stroke="#BDBDBD"
                      stroke-width="1.5"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                ...
                <input
                  ...
                  className="text-base font-normal focus:outline-none focus:ring-0 seletor text-black font-bl my-5  bg-white"
                  placeholder="Enter your Password"
                />
              </div>{" "}
              <div
                onClick={togglePasswordVisibility}
                className="justify-right text-black bg-white"
              >
                {!showPassword ? (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
...
<h1 className='selector text-[15px]  font-normal text-[#E5E5E5]'>Forgot password?</h1>
          ...
          <button
            onClick={login1}
            className="mt-14 selector bg-[#0c2d57] border-white border-2 hover:bg-[#0c2d57]/70 rounded-full text-[#E5E5E5] text-xl font-bold px-12 py-[14px]"
          >
        ...
        <div className="flex flex-col  h-screen justify-center align-middle items-center bg-secondary">
          ...
          {/* </svg> */}
          <h1 className="selector text-[70px] font-normal font-cursive text-[#E5E5E5] ">
            Nawalah
          </h1>
        </div>
      </div>
