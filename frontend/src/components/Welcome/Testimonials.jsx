...
const TestimonialData = [
  {
    id: 1,
    name: "Ahmed Afzal",
    text: "A very good facility for the students like us to get a good food at a reasonable price.",
    img: "https://picsum.photos/101/101",
  },
  {
    id: 2,
    name: "Muhammad Fakhar",
    text: "Its amazing! All my favourite restaurants are present at the same place and the delivery system is also very swift.",
