...
const User = () => {
  ...
  const getAllUser = async () => {
      const addUser = collection(firestore,   "clients");
  ...
  return (
    <div className='mx-[56px] md:mx-6 sm:mx-3 sm:pl-4 mt-[25px]'>
       <div className="justify-between items-center  w-full flex">
       <h1 className='selector text-[#E5E5E5] text-xl my-7 font-bold'>All User</h1>
  ...
  <path d="M22 22L20 20" stroke="#BDBDBD" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        onChange={handleSearchInputChange} className='text-base w-[300px]  focus:outline-none focus:ring-0 font-normal selector text-[#E5E5E5] my-2  bg-brandDark' placeholder='Search user'/>
                  ...
                  {filtereduser?.map((val, ind) => (
                    ...
                    />
                      ...
                      <td className="w-[200px] items-center text-center justify-center">
                        ...
                        >
                        <img  class="w-10 h-10 items-center text-center justify-center rounded-full"
                          src={val.photo} alt="" /></div>
 
                        </td>
                      <td className="w-[200px] items-center text-center justify-center" > 
                      {val.userName}  
                      </td>
                      <td className="w-[200px] items-center text-center justify-center">{val.id}</td>
                      ...
                      <td className="w-[200px] items-center text-center justify-center">{getorders(val.id)}</td>
                      <td className="w-[200px] items-center text-center justify-center">
                      <div className='flex flex-row gap-3 cursor-pointer items-center text-center justify-center'>
                      <div className="cursor-pointer"  onClick={()=> deleteuser(val.id)} ><DeleteOutline   /></div>
      ...
      >
         <div class={`absolute top-0 right-0 h-screen px-5 py-6 md:mr-0 sm:mr-0   text-base list-none bg-[#2A2A2A] shadow-[#0000004d] divide-y-0 sm:divide-y rounded-l-lg shadow  divide-gray-600" id="user-dropdown`}>
        <div className='flex '>
         <button
            ...
            <h1 className='selector text-[#E5E5E5] text-[25px] pr-[175px] pt-2 pl-[116px]  font-bold'>Edit User</h1>
...
<h1 className='text-[#BDBDBD] selector text-xs font-normal cursor-pointer'  onClick={handleClick}>Select Item Image</h1>
            ...
            <div className='mt-[24px] xl:mt-[20px] ml-[29px]'>
                <h1 className='selector text-[#E5E5E5] font-normal xl:text-[20px] text-[25px]'>User Detail</h1>
            ...
            <input type="text"   value={updateData["userName"]} name="userName"
             onChange={(e) =>  setUpdateData({ ...updateData, ["userName"]: e.target.value })}  className='text-base   focus:outline-none focus:ring-0 font-normal seletor text-[#E5E5E5] my-5  bg-[#353535]' placeholder=' Name'/>
            </div>
            ...
            <input type="text"   value={updateData["schoolName"]} name="schoolName"
             onChange={(e) =>  setUpdateData({ ...updateData, ["schoolName"]: e.target.value })}   className='text-base   focus:outline-none focus:ring-0 font-normal seletor text-[#E5E5E5] my-5  bg-[#353535]' placeholder='school name'/>
            </div>
                    
            <div className=' mt-[8px] rounded-full justify-between w-[377px] h-12  xl:h-10 items-center px-4 flex flex-row gap-3 border-[#bdbdbd0d] border-solid bg-[#353535]'>
            <input type="tel"    name="phoneNumber"
           value={updateData["phoneNumber"]}  onChange={(e) =>  setUpdateData({ ...updateData, ["phoneNumber"]: e.target.value })} className='text-base   focus:outline-none focus:ring-0 font-normal seletor text-[#E5E5E5] my-5  bg-[#353535]' placeholder='phone no'/>
            </div>

            <div className=' mt-[8px] rounded-full justify-between w-[377px] h-12  xl:h-10 items-center px-4 flex flex-row gap-3 border-[#bdbdbd0d] border-solid bg-[#353535]'>
            <input type="number"   value={updateData["rewards"]} name="rewards"
             onChange={(e) =>  setUpdateData({ ...updateData, ["rewards"]:  parseInt(e.target.value) })}   className='text-base w-full  focus:outline-none focus:ring-0 font-normal seletor text-[#E5E5E5] my-5  bg-[#353535]' placeholder='rewards'/>
            </div>
